...
const Landing = () => {
  ...
  return (
    <div className="bg-black relative">
      ...
      <button className="pl-4 pb-4 ml-8 font-lexend rounded-2xl">
          <button className="text-white bg-gray-800 py-2 px-8">Events</button>
          <button className="text-white bg-gray-600 py-2 px-8">Collections</button>
      </button>
      <div className="flex gap-10 absolute top-[20%] left-[15%]">
        {/* AUTOPLAY SLIDER */}
        <div className="flex gap-8 w-[50%] overflow-hidden transition-transform">
        ...
        <div className="text-white font-lexend w-[47%] pl-20 absolute right-0 top-[-25%]">
          <p className="text-xl font-bold py-8 w-[60%]">Explore Your First Collectible</p>
          <h1 className="text-4xl font-bold w-[50%] leading-[2.75rem]">Meta Lives</h1>
          <p className="py-4">Live in Astrix</p>
          <p className="text-[0.85rem]">
          Join us for an evening of enchantment at the Grand Gala Extravaganza, where the stars align to create unforgettable memories.
          </p>
          <div className="grid grid-cols-2 my-8">
            <div className="flex relative ">
                <img className='absolute left-0 z-0' src={person1} alt="person1" />
                <img className='absolute left-[12%] z-10' src={person2} alt="person2" />
                <img className='absolute left-[24%] z-20' src={person3} alt="person3" />
                <img className='absolute left-[36%] z-30' src={person4} alt="person4" />
                <img className='absolute left-[48%] z-40' src={person5} alt="person5" />
            </div>
          ...
          <div className="flex gap-4 text-black overflow-hidden">
            <div className="flex flex-col justify-center bg-[#B9A0FF] p-2 rounded-lg flex-shrink-0">
              <div className="flex justify-between text-[0.65rem]">
                <p className="bg-black text-white rounded-3xl px-2">2024</p>
                <p>By Pablo</p>
              </div>
              <h1 className="text-center my-2 text-[0.65rem] font-semibold ">Collectible Name</h1>
              <img
          ...
          <div className="flex justify-end m-4 pt-10 ">
            <button className="bg-[#FFCA5F] text-black p-2 font-medium rounded-3xl" >Join Waitlist</button>
          </div>
        </div>
      </div>
      {/* VERTICAL SLIDER */}
